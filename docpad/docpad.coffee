...
docpadConfig = {
	...
	templateData:
		...
		site:
			...
			url: "http://frontendfrogs.org/frontrend/"
			...
			description: """
				フロントエンドの最先端で活躍中のデザイナー、プログラマーが 現場で使われている最新の技術や知識、フロントエンドの未来に ついて分かりやすく解説！今回は Frontrend 最終章の企画として 「Webプログラマー」向け、「Webデザイナー」向けのハンズオンも同時開催！！他にもデザイナー、プログラマー必見の最強講師陣が登壇します。福岡の熱い冬を是非体験ください！！
				"""
